...
namespace PuzzleInfo
{
    public class FindPuzzlePos
    {
        static Vector3[][] normalPuzzlePos_A ={
                 ...
                 new Vector3[]{ Vector3.zero, new Vector3(100, 400, 0) } //moonNight
            };//A[land][puzzle] day

        static Vector3[][] normalPuzzlePos_B ={
                 new Vector3[]{ new Vector3(0, 0, 0), new Vector3(400, 900, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0) , new Vector3(650, 530, 0) , new Vector3(460, 850, 0) , new Vector3(200, 1100, 0) , Vector3.zero, new Vector3(320, 750, 0), new Vector3(-100, 0, 0), new Vector3(-100, 0, 0)   },
        ...
        static Vector3[][] normalPuzzlePos_C ={
                 new Vector3[]{ new Vector3(0, 0, 0), new Vector3(400, 900, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0) , new Vector3(650, 530, 0) , new Vector3(460, 850, 0) , new Vector3(-100, 0, 0) , Vector3.zero, new Vector3(320, 750, 0), new Vector3(-100, 0, 0), new Vector3(-100, 0, 0)   },
                 new Vector3[]{Vector3.zero, new Vector3(100, 400, 0), new Vector3(100, 400, 0) , Vector3.zero, new Vector3(100, 400, 0), new Vector3(100, 400, 0) , Vector3.zero, new Vector3(100, 400, 0) , new Vector3(100, 400, 0) },
                 new Vector3[]{ Vector3.zero, new Vector3(100, 400, 0) }
            };//C
        ...
        public static Vector3 puzzlePos(string puzzleID, int weather) {
            ...
            if(PuzzleManager.instance.puzzles[_landID-1][_puzzleID-1].type == "N")
            {
                ...
                {
                    if (_puzzleID <= normalPuzzlePos[targetNum][_landID - 1].Length) { tPos = normalPuzzlePos[targetNum][_landID - 1][_puzzleID - 1]; }
