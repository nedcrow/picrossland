...
namespace PuzzleInfo
{
    public class FindPuzzlePos
    {
        static Vector3[][] normalPuzzlePos_A ={
                 new Vector3[]{ Vector3.zero, new Vector3(400, 900, 0), Vector3.zero, new Vector3(200, 800, 0), new Vector3(650, 530, 0), new Vector3(460, 850, 0), new Vector3(-100, -100, 0), Vector3.zero, new Vector3(270, 700, 0)  },
        ...
        static Vector3[][] normalPuzzlePos_B ={
                 new Vector3[]{ new Vector3(0, 0, 0), new Vector3(400, 900, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 0) , new Vector3(650, 530, 0) , new Vector3(460, 850, 0) , new Vector3(200, 1100, 0) , new Vector3(0, 0, 0), new Vector3(270, 700, 0)   },
                 new Vector3[]{Vector3.zero, new Vector3(100, 400, 0), new Vector3(100, 400, 0) , Vector3.zero, new Vector3(100, 400, 0), new Vector3(100, 400, 0) , Vector3.zero, new Vector3(100, 400, 0) , new Vector3(100, 400, 0) },
                 new Vector3[]{ Vector3.zero, new Vector3(100, 400, 0) }
            };//B
