...
namespace PuzzleInfo
{
    public class FindPuzzlePos
    {
        static Vector3[][] normalPuzzlePos_A ={
                 ...
                 new Vector3[]{ Vector3.zero, new Vector3(150, 750, 0), new Vector3(160, 620, 0), new Vector3(570, 650, 0), Vector3.zero, new Vector3(-100, -100, 0), new Vector3(-100, -100, 0), Vector3.zero,  new Vector3(-100, 0, 0), new Vector3(-100, 0, 0), Vector3.zero, new Vector3(-100, 0, 0)}, //12 (s : 1,5,8,11)
        ...
        static Vector3[][] normalPuzzlePos_B ={
                 ...
                 new Vector3[]{ Vector3.zero, new Vector3(150, 750, 0), new Vector3(160, 620, 0), new Vector3(-100, 0, 0), Vector3.zero, new Vector3(440, 960, 0), new Vector3(560, 620, 0), Vector3.zero, new Vector3(-100, 0, 0),new Vector3(-100, 0, 0), Vector3.zero, new Vector3(-100, 0, 0)},
                 new Vector3[]{ Vector3.zero, new Vector3(-100, 0, 0) },
                 new Vector3[]{ Vector3.zero, new Vector3(-100, 0, 0) }
            };//B
        ...
        static Vector3[][] normalPuzzlePos_D ={
                 new Vector3[]{ Vector3.zero, new Vector3(400, 900, 0)},
                 new Vector3[]{ Vector3.zero, new Vector3(-100, 100, 0), new Vector3(-100, 0, 0), new Vector3(-100, 0, 0), Vector3.zero, new Vector3(-100, 0, 0), new Vector3(-100, 0, 0), Vector3.zero, new Vector3(-100, 0, 0),new Vector3(-100, 0, 0), Vector3.zero, new Vector3(320, 700, 0)},
                 new Vector3[]{ Vector3.zero, new Vector3(-100, 0, 0) },
                 new Vector3[]{ Vector3.zero, new Vector3(-100, 0, 0) }
            };//D
