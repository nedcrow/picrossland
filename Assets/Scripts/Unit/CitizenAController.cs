...
public class CitizenAController : MonoBehaviour {
    ...
    Vector3[] secondPos = { new Vector3(0, -0.3f, -3.3f), new Vector3(0.1f, -0.3f, -3.3f), new Vector3(-0.2f, -0.3f, -3.3f) };//-20~20, -3f+y;
    ...
    Vector3[] fifthPos = { new Vector3(-1.4f, -1f, -4f), new Vector3(1.5f, -2f, -5f), new Vector3(1.7f, -4f, -7f) };//-20~20, -3f+y;
